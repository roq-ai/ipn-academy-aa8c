...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Workshop Attendee'];
  const tenantRoles: string[] = ['Workshop Trainer', 'Customer Support', 'Business Owner'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `IPN Academy`;
