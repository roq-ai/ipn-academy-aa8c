        ...
        {isLoading ? (
          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  {hasAccess('workshop', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>workshop</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    {hasAccess('workshop', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/workshops/view/${record.workshop?.id}`}>
