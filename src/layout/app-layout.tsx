...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'workshop-trainer', 'customer-support'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Workshop', path: '/workshops', entity: 'workshop', service: AccessServiceEnum.PROJECT, icon: FiMonitor },
